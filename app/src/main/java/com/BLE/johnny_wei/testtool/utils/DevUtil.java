...
import static com.BLE.johnny_wei.testtool.config.globalConfig.PERMISSION_REQUEST_READ_EXTERNAL_STORAGE;
...
public class DevUtil {
    ...
    public static void printDeviceInfo() {
        Log.d(TAG,"app ver:" + "1.0");
        Log.d(TAG, "phone:" + GetBrand() + " " + GetDeviceModel());
        Log.d(TAG, "ver:" + "Android: " + GetSystemVersion() + " API " + GetVersionSDK());
