...
import com.BLE.johnny_wei.testtool.adapter.Group;
import com.BLE.johnny_wei.testtool.adapter.Item;
import com.BLE.johnny_wei.testtool.adapter.MyBaseExpandableListAdapter;

import java.util.ArrayList;

public class expandleble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expandleble);

        mContext = expandleble.this;
