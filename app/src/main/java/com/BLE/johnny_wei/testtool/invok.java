...
import com.BLE.johnny_wei.testtool.BLETest.Invoke_sample;
import com.BLE.johnny_wei.testtool.BLETest.test_class1;
import com.BLE.johnny_wei.testtool.BLETest.test_class2;
import com.BLE.johnny_wei.testtool.utils.csv_util.CSV_ReaderUtil;
...
public class invok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            clz = Class.forName("com.BLE.johnny_wei.testtool.BLETest.Invoke_sample");
...
//        invokePrivateMothod2();
    ...
    private static void creatClassByReflection() {
        try {
            Invoke_sample accpTeacher = (Invoke_sample) Class.forName("com.BLE.johnny_wei.testtool.BLETest.Invoke_sample")
                    .newInstance();
